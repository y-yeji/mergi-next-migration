...
const ProfilePromptModal = () => {
  return (
    <div className="min-h-screen mx-auto flex justify-center items-center mt-[100px]">
      <Dialog>
        <form>
          ...
          >
            <DialogHeader>
              <DialogTitle className="mb-[17px] text-center">
                <p className="h2-b">
                  환영합니다, <span className="text-primary-3">병알이</span> 님!
                </p>
              </DialogTitle>
            ...
            <DialogFooter>
              <DialogClose asChild>
                <Button className="w-[179px] h-[45px] py-3 text-gray-70 rounded-lg body-r hover:text-black cursor-pointer modal-button-shadow">
                  나중에 할게요
                </Button>
              </DialogClose>
